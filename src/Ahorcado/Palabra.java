...
public class Palabra {
	...
	/**
	 * Constructor que genera una palabra de forma aleatoria (p_oculta) también
	 * inicializa un Array (p_visible) con "_" en cada una de las letras estos
	 * subrayados se irán sustituyendo según se vayan adividando las letras
	 */
	public Palabra() {
	...
	/**
	 * Método que sirve para mostrar la parte visible de la palabra (p_visible) Se
	 * imprimen las letras separadas por un espacio y un salto de línea al final
	 */
	...
	/**
	 * Método que busca las letras en la palabra (p_oculta) y además, en caso de
	 * encontrarla la pone en la parte visible (p_visible) en su posición correcta
	 * de este modo cuando se imprime la parte visible
	 * 
	 * @param c El carácter a buscar en la palabra completa (p_oculta)
	 * @return Se devuelve el número de aciertos, es decir, el número de veces que
	...
	/**
	 * Método que cuenta el número de letras diferentes que tiene la palabra
	 * (p_oculta)
	 * 
