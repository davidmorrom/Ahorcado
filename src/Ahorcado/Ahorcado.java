...
public class Ahorcado {
	...
	public static void main(String[] args) {
		...
		// El número de intentos será igual al número de letras diferentes que tiene la
		// palabra
		...
		do {
			...
			System.out.println();
			// Se repite el bucle mientras haya intentos disponibles y la palabra no haya
			// sido descubierta
